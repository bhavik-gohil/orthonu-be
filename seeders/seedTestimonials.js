...
const testimonials = [
  {
    ...
    "by": "Dr Marc Lemchen",
    "from": "Lemchen Salzer Orthodontics"
  },
  {
    ...
    "from": "Orthodontic Partners, OrthoFi and Reynolds Orthodontics"
  },
  {
    "text": "I think the Tweakz for Braces is genius, particularly the distal end cutters.",
    "by": "",
    "from": "Queens Gate Orthodontics UK"
  },
  {
  ...
  },
  {
    ...
    "by": "Dr Ashley Kissling",
    "from": "SOCO Pediatric Dentistry and Orthodontic Care"
  },
  {
...
async function seed() {
    try {
        console.log('Clearing and Seeding ALL testimonials...');
        await Testimonial.destroy({ where: {} });
        
        for (const t of testimonials) {
            await Testimonial.create(t);
        }
        console.log('Seeding completed successfully with ' + testimonials.length + ' records.');
        process.exit(0);
    } catch (error) {
